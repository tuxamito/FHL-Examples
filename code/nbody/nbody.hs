...
main = print (tripleListShow (loop (iposs, ivels) 33))
  where
    iposs = [generateT 1, generateT 2, generateT 3]
    ivels = [generateT 0, generateT 0, generateT 0]
